...
**CI/CD (bônus):** o workflow `.github/workflows/ci.yml` roda lint (ruff), testes pytest (`tests/test_api.py`) e smoke test do `mlflow_tracking`. Run de exemplo (sucesso): https://github.com/cavalcanteprofissional/sentiment-analysis/actions/runs/33595619625
...
- **CI/CD** via GitHub Actions — o workflow `.github/workflows/ci.yml` roda em cada push para `main`:
  ...
  - Run de sucesso: https://github.com/cavalcanteprofissional/sentiment-analysis/actions/runs/33595619625
